...
public class PersistenceConfig {
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("spring.jpa.hibernate.dialect", environment.getRequiredProperty("hibernate.dialect"));
        properties.put("spring.jpa.hibernate.show_sql", environment.getProperty("hibernate.show_sql", "false"));
